...
4º No menu modelos, escolher um modelo, clicar em detalhes, será detalhado as operações do modelo, para gerar uma cobrança basta clicar em GERAR COBRANÇA  e preencher as gerar com auxilio da
